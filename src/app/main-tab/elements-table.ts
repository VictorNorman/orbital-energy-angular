...
const PTABLE_ROWS: PCell[][] = [
  [ elem('H',1,'group-12','row1'), E,E,E,E,E,E,E,E,E,E,E,E,E,E,E,E, elem('He',2,'group-12','row1') ],
  [ elem('Li',3,'group-12','row2'), elem('Be',4,'group-12','row2'), E,E,E,E,E,E,E,E,E,E,
    elem('B',5,'group-nm','row2'), elem('C',6,'group-nm','row2'), elem('N',7,'group-nm','row2'),
    elem('O',8,'group-nm','row2'), elem('F',9,'group-nm','row2'), elem('Ne',10,'group-nm','row2') ],
  [ elem('Na',11,'group-12','row3'), elem('Mg',12,'group-12','row3'), E,E,E,E,E,E,E,E,E,E,
    elem('Al',13,'group-nm','row3'), elem('Si',14,'group-nm','row3'), elem('P',15,'group-nm','row3'),
    elem('S',16,'group-nm','row3'), elem('Cl',17,'group-nm','row3'), elem('Ar',18,'group-nm','row3') ],
  [ elem('K',19,'group-12'), elem('Ca',20,'group-12'),
    ...
    elem('As',33,'group-nm'), elem('Se',34,'group-nm'), elem('Br',35,'group-nm'), elem('Kr',36,'group-nm') ],
  [ elem('Rb',37,'group-12'), elem('Sr',38,'group-12'),
    ...
    elem('Sb',51,'group-nm'), elem('Te',52,'group-nm'), elem('I',53,'group-nm'), elem('Xe',54,'group-nm') ],
  [ elem('Cs',55,'group-12'), elem('Ba',56,'group-12'), elem('La',57,'group-transition'),
    ...
    elem('Po',84,'group-nm'), elem('At',85,'group-nm'), elem('Rn',86,'group-nm') ],
  [ elem('Fr',87,'group-12'), elem('Ra',88,'group-12'), elem('Ac',89,'group-transition'),
    ...
    elem('Lv',116,'group-nm'), elem('Ts',117,'group-nm'), elem('Og',118,'group-nm') ],
